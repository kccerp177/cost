...
// ─── 현장 Mock 데이터 (5개, 상태 다양) ───────────────────────
// hasQuantity: 산출된 물량 有 → Step 4 점프
// hasDrawing : 도면만 有 → Step 3 점프 (사용 여부 선택)
// 둘 다 없음 : 이미지 업로드 필요
const QC_SITES = [
  {
